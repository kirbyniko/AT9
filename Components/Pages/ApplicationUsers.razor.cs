...
namespace AT9.Components.Pages
{
    public partial class ApplicationUsers
    {
        ...
        protected IEnumerable<AT9.Models.ApplicationUser> users;
        protected RadzenDataGrid<AT9.Models.ApplicationUser> grid0;
        ...
        protected async Task RowSelect(AT9.Models.ApplicationUser user)
        {
        ...
        protected async Task DeleteClick(AT9.Models.ApplicationUser user)
        {
            try
            {
