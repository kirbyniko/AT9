...
{
    public partial class EditGalleryVideo
    {
        [Inject]
        ...
        {
            galleryVideo = await AbstractTheatreService.GetGalleryVideoByGalleryVideoId(GalleryVideoId);
        }
        ...
        protected async Task FormSubmit()
        {
            ...
            else
            {
                try
                {
                    await AbstractTheatreService.UpdateGalleryVideo(GalleryVideoId, galleryVideo);
